...
public class FakeDishes implements DishRepository {
    ...
    public FakeDishes() {
        ...
        Dish couscous = new Dish("1", "couscous", 50.0);
        dishes.put("1", couscous);
        Dish salade = new Dish("2", "salade", 15.0);
        dishes.put("2", salade);
        Dish sushis = new Dish("3", "sushis", 25.0);
        dishes.put("3", sushis);
        Dish poulet = new Dish("4", "poulet", 6.0);
        dishes.put("4", poulet);
        Dish ratatouille = new Dish("5", "ratatouille", 16.0);
